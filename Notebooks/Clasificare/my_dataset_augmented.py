...
class DRDatasetAugmented(Dataset):
    def __init__(self, root_dir, dataset_name, split='train', image_size=224):
        ...
        și echilibrate direct din folderul 'datasets_augmented'.
        """
        self.dataset_name = dataset_name.lower()
        self.split = split.lower()
        self.image_size = image_size
        
        # Noua structură simplificată: datasets_augmented/nume/train/
        self.base_dir = os.path.join(root_dir, 'datasets_augmented', self.dataset_name, self.split)
