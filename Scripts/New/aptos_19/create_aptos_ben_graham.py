...
def parse_args():
    ...
    parser = argparse.ArgumentParser(
        description=(
            "Reface datasets/aptos/aptos_ben_graham_part_2 din aptos_augmented_balanced "
    ...
    parser.add_argument(
        "--output_dir",
        type=Path,
        default=root / "datasets" / "aptos" / "aptos_ben_graham_part_2",
    )
...
def safe_prepare_output(output_dir, overwrite):
    ...
    if output_dir.name != "aptos_ben_graham_part_2":
